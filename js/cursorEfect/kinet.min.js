(function webpackUniversalModuleDefinition(root, factory) {
    ...
    else if (typeof exports === "object") exports["Kinet"] = factory();
    else root["Kinet"] = factory();
})(window, function () {
                    ...
                    _createClass(Kinet, [
                        {
                            ...
                            value: function set(name, num) {
                                ...
                                if (!this._raf) {
                                    this._handlers["set"].forEach(function (
                                        handler
                                    ) {
                                        return handler(_this2._instances);
                                    });
                                    this._handlers["tick"].forEach(function (
                                        handler
                                    ) {
                                        return handler(_this2._instances);
                                    });
                        ...
                        },
                        {
                            ...
                            value: function _animateValues() {
                                ...
                                Object.keys(this._instances).forEach(function (
                                    key
                                ) {
                                    _this4._instances[key].update();

                                    if (
                                        _this4._options.test(
                                            _this4._instances[key]
                                        )
                                    ) {
                                        done = false;
                                    }
                                ...
                                if (!done) {
                                    ...
                                    // set to final values
                                    Object.keys(this._instances).forEach(
                                        function (key) {
                                    ...
                                    this._handlers["end"].forEach(function (
                                        handler
                                    ) {
                                        return handler(_this4._instances);
                                    });
                                ...
                                if (event != null) {
                                    if (handler != null) {
                                        if (
                                            ...
                                            var toRemove = this._handlers[
                                                event
                                            ].filter(function (savedHandler) {
                                                return savedHandler === handler;
                                            })[0];
                                            var index =
                                                this._handlers[event].indexOf(
                                                    toRemove
                                                );
                                            if (index > -1) {
